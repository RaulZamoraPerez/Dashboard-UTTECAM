      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ComponentCard title="Noticias Publicadas">
            <div className="flex items-center justify-between">
              <div className="text-2xl font-bold text-success">{noticias.filter(n => n.estado === 'Publicada').length}</div>
          ...
          <ComponentCard title="Borradores">
            <div className="flex items-center justify-between">
              <div className="text-2xl font-bold text-warning">{noticias.filter(n => n.estado === 'Borrador').length}</div>
          ...
          <ComponentCard title="Total Visitas">
            <div className="flex items-center justify-between">
              <div className="text-2xl font-bold text-info">{totalVisitas}</div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-white/[0.05]">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <svg className="size-4" fill={noticia.destacada ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
